...
public final class AuthUrlPolicyTest {
    ...
    public void acceptsExactPkceCallbackAndPreservesProviderErrors() {
        assertTrue(AuthUrlPolicy.isAllowedCallbackUrl(
                "com.franceisl.glowletternext.debug://auth/callback?code=one-time-code"
        ));
        assertTrue(AuthUrlPolicy.isAllowedCallbackUrl(
                "com.franceisl.glowletternext.debug://auth/callback?error=access_denied&error_description=Cancelled"
        ));
        assertTrue(AuthUrlPolicy.isAllowedCallbackUrl(
                "com.franceisl.glowletternext.debug://AUTH/callback?code=one-time-code&safe_extra=value"
        ));
        ...
        assertFalse(AuthUrlPolicy.isAllowedCallbackUrl(
                "com.franceisl.glowletternext.debug://evil/callback?code=one-time-code"
        ));
        assertFalse(AuthUrlPolicy.isAllowedCallbackUrl(
                "com.franceisl.glowletternext.debug://auth/callback/extra?code=one-time-code"
        ));
        assertFalse(AuthUrlPolicy.isAllowedCallbackUrl(
                "com.franceisl.glowletternext.debug://user@auth/callback?code=one-time-code"
        ));
        assertFalse(AuthUrlPolicy.isAllowedCallbackUrl(
                "com.franceisl.glowletternext.debug:auth/callback?code=one-time-code"
        ));
        assertFalse(AuthUrlPolicy.isAllowedCallbackUrl(
                "com.franceisl.glowletternext.debug://auth/callback#access_token=legacy"
        ));
        assertFalse(AuthUrlPolicy.isAllowedCallbackUrl(
                "com.franceisl.glowletternext.debug://auth/callback?code=one&code=two"
        ));
        assertFalse(AuthUrlPolicy.isAllowedCallbackUrl(
                "com.franceisl.glowletternext.debug://auth/callback?error=one&%65rror=two"
        ));
        assertFalse(AuthUrlPolicy.isAllowedCallbackUrl(
                "com.franceisl.glowletternext.debug://auth/callback?error=one&error_description=a&error_description=b"
        ));
