...
assert.ok(index.indexOf("vendor/supabase-2.110.9.js?v=12") < index.indexOf("reply-engine.js?v=12"));
assert.ok(index.indexOf("reply-engine.js?v=12") < index.indexOf("app.js?v=12"));
...
assert.match(worker, /glow-letter-next-v12/);
for (const resource of ["styles.css", "experience.css", "config.js", "supabase-2.110.9.js", "letters.js", "reply-engine.js", "app.js", "experience.js", "manifest.webmanifest"]) {
  assert.match(worker, new RegExp(`${resource.replaceAll(".", "\\.")}\\?v=12`));
}
...
console.log(JSON.stringify({ ok: true, sdk: vendorMetadata.version, cache: "v12", replyEngine: true, safeAppShare: true, rls: true }));
