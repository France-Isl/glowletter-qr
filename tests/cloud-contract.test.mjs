...
assert.ok(index.indexOf("vendor/supabase-2.110.9.js?v=34") < index.indexOf("letters.js?v=34"));
assert.ok(index.indexOf("letters.js?v=34") < index.indexOf("vendor/qrcode-generator-1.4.4.min.js?v=34"));
assert.ok(index.indexOf("vendor/qrcode-generator-1.4.4.min.js?v=34") < index.indexOf("qr-code.js?v=34"));
assert.ok(index.indexOf("qr-code.js?v=34") < index.indexOf("app.js?v=34"));
...
// Service-worker v34 must update its own cache only and never cache personalized links.
assert.match(worker, /const CACHE_PREFIX = "glow-letter-"/);
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v34`/);
for (const resource of ["styles.css", "experience.css", "email-auth.css", "moments.css", "config.js", "supabase-2.110.9.js", "qrcode-generator-1.4.4.min.js", "letters.js", "qr-code.js", "app.js", "email-auth.js", "moments.js", "experience.js", "manifest.webmanifest"]) {
  assert.match(worker, new RegExp(`${resource.replaceAll(".", "\\.")}\\?v=34`));
}
for (const resource of ["styles.css", "experience.css", "email-auth.css", "moments.css", "config.js", "supabase-2.110.9.js", "qrcode-generator-1.4.4.min.js", "letters.js", "qr-code.js", "app.js", "email-auth.js", "moments.js", "experience.js", "manifest.webmanifest"]) {
  assert.match(index, new RegExp(`${resource.replaceAll(".", "\\.")}\\?v=34`));
}
assert.match(index, /fonts\/local-fonts\.css\?v=34/);
assert.doesNotMatch(index, /fonts\.googleapis\.com|fonts\.gstatic\.com/);
assert.match(worker, /fonts\/local-fonts\.css\?v=34/);
assert.match(app, /serviceWorker\.register\("sw\.js\?v=34"/);
