...
Отдельная экспериментальная версия GlowLetter. Она не изменяет и не публикует исходный сайт `pismo-dlya-aishi`.

Новые возможности: четыре локальных зацикленных видеофона, прозрачная читаемая открытка, премиум-рамки, палитры текста, умная автопалитра и отдельная устанавливаемая Android preview-сборка.
