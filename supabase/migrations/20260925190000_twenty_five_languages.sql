-- GlowLetter speaks twenty-five languages: Russian, English, French, German,
-- Spanish, Italian, Polish, Ukrainian, Portuguese, Dutch, Turkish, Romanian,
-- Czech, Swedish, Greek, Danish, Norwegian, Finnish, Japanese, Korean,
-- Chinese (Traditional), Thai, Arabic, Indonesian and Vietnamese.
...
alter table public.glowletter_progress
  ...
  add constraint glowletter_progress_language_check
    check (language in ('ru', 'en', 'fr', 'de', 'es', 'it', 'pl', 'uk', 'pt', 'nl', 'tr', 'ro', 'cs', 'sv', 'el', 'da', 'no', 'fi', 'ja', 'ko', 'zh', 'th', 'ar', 'ind', 'vi'));
...
begin
  ...
  if normalized_language not in ('ru', 'en', 'fr', 'de', 'es', 'it', 'pl', 'uk', 'pt', 'nl', 'tr', 'ro', 'cs', 'sv', 'el', 'da', 'no', 'fi', 'ja', 'ko', 'zh', 'th', 'ar', 'ind', 'vi') then
