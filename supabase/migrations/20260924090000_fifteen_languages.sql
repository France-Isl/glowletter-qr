-- GlowLetter speaks fifteen languages: Russian, English, French, German,
-- Spanish, Italian, Polish, Ukrainian, Portuguese, Dutch, Turkish, Romanian,
-- Czech, Swedish and Greek. Every stored language code is widened together.
...
alter table public.glowletter_progress
  ...
  add constraint glowletter_progress_language_check
    check (language in ('ru', 'en', 'fr', 'de', 'es', 'it', 'pl', 'uk', 'pt', 'nl', 'tr', 'ro', 'cs', 'sv', 'el'));
...
begin
  ...
  if normalized_language not in ('ru', 'en', 'fr', 'de', 'es', 'it', 'pl', 'uk', 'pt', 'nl', 'tr', 'ro', 'cs', 'sv', 'el') then
