-- GlowLetter speaks ten languages: Russian, English, French, German, Spanish,
-- Italian, Polish, Ukrainian, Portuguese and Dutch. Every stored language code
-- is widened together.
...
alter table public.glowletter_progress
  ...
  add constraint glowletter_progress_language_check
    check (language in ('ru', 'en', 'fr', 'de', 'es', 'it', 'pl', 'uk', 'pt', 'nl'));
...
begin
  ...
  if normalized_language not in ('ru', 'en', 'fr', 'de', 'es', 'it', 'pl', 'uk', 'pt', 'nl') then
